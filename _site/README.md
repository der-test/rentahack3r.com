...
<div class="disclaimer">
  ...
  This simulator is entirely <strong>fictional entertainment</strong> referencing retro hacker culture for educational purposes only.
...
(function() {
  ...
  function showMessage(type) {
    ...
    setTimeout(function() {
      messageDiv.remove();
      // Keep popup hidden for 20 more seconds, then resume cycle
      setTimeout(function() {
